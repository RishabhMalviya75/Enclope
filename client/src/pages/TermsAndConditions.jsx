            ...
            <div className="container mx-auto px-6 max-w-4xl relative z-10">
                ...
                >
                    ...
                    <motion.div
                        ...
                        variants={fadeInUp}
                    >
                        These terms cover the <strong className="text-white">enclop.com website and our
                        client services</strong>. They do not govern our games. If you play{' '}
                        <strong className="text-white">Camo Crew</strong>, the terms that apply to you are the{' '}
                        <Link to="/camocrew/terms" className="text-accent hover:underline">Camo Crew Terms</Link>.
                    </motion.div>
                </motion.div>
                ...
                >
                    ...
                    <motion.section variants={fadeInUp}>
                        ...
                        <p>
                            Welcome to Enclop. These Terms and Conditions ("Terms") govern your use of our website and services. By accessing our website or engaging our services, you agree to be bound by these Terms. If you do not agree with any part of these Terms, please do not use our services.
                        </p>
                    </motion.section>
                    ...
                    <motion.section variants={fadeInUp}>
                        ...
                        <p className="mb-4">Enclop provides digital services across three categories:</p>
                    ...
                    <motion.section variants={fadeInUp}>
                        ...
                        <ul className="list-disc list-inside space-y-2 ml-4">
                            <li><span className="text-white">Ownership:</span> All deliverables, including but not limited to source code, designs, and assets, remain the intellectual property of Enclop unless otherwise agreed in writing.</li>
                            ...
                            <li><span className="text-white">Portfolio Rights:</span> Enclop reserves the right to showcase completed work in our portfolio, case studies, and marketing materials unless explicitly prohibited by prior written agreement.</li>
                        </ul>
                    </motion.section>
                    ...
                    <motion.section variants={fadeInUp}>
                        ...
                        <ul className="list-disc list-inside space-y-2 ml-4">
                            <li>Enclop is <span className="text-white">not liable</span> for any indirect, incidental, special, consequential, or punitive damages, including but not limited to loss of profits, data, or business opportunities.</li>
                    ...
                    <motion.section variants={fadeInUp}>
                        ...
                        <ul className="list-disc list-inside space-y-2 ml-4">
                            ...
                            <li>Enclop reserves the right to terminate services immediately if payment is overdue or if prohibited use is detected.</li>
                        </ul>
                    </motion.section>
